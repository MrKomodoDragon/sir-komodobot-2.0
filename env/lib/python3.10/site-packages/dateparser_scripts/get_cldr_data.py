...
def _retrieve_locale_data(locale):
    ...
    try:
        ...
        date_format_string = gregorian_dict['dateFormats']['short'][
            '_value'
        ].upper()
    ...
    json_dict['year'] = [
        date_fields_dict[key]['displayName'] for key in year_keys
    ]

    json_dict['month'] = [
        date_fields_dict[key]['displayName'] for key in month_keys
    ]

    json_dict['week'] = [
        date_fields_dict[key]['displayName'] for key in week_keys
    ]

    json_dict['day'] = [
        date_fields_dict[key]['displayName'] for key in day_keys
    ]

    json_dict['hour'] = [
        date_fields_dict[key]['displayName'] for key in hour_keys
    ]

    json_dict['minute'] = [
        date_fields_dict[key]['displayName'] for key in minute_keys
    ]

    json_dict['second'] = [
        date_fields_dict[key]['displayName'] for key in second_keys
    ]
...
def main():
    ...
    for language in language_locale_dict:
        ...
        for locale in locales_list:
            ...
            locale_specific_dict[locale] = get_dict_difference(
                json_language_dict, json_locale_dict
            )
