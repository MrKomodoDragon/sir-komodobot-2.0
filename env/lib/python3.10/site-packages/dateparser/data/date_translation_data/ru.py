info = {
    'name': 'ru',
    'date_order': 'DMY',
    'january': ['январь', 'янв', 'января'],
    'february': ['февраль', 'февр', 'февраля', 'Фев'],
    'march': ['март', 'марта', 'мар'],
    'april': ['апрель', 'апр', 'апреля'],
    'may': ['май', 'мая'],
    'june': ['июнь', 'июня', 'июн'],
    'july': ['июль', 'июля', 'июл'],
    'august': ['август', 'авг', 'августа'],
    'september': ['сентябрь', 'сент', 'сентября', 'Сен'],
    'october': ['октябрь', 'окт', 'октября'],
    'november': ['ноябрь', 'нояб', 'ноября', 'Ноя'],
    'december': ['декабрь', 'дек', 'декабря'],
    'monday': ['понедельник', 'пн'],
    'tuesday': ['вторник', 'вт'],
    'wednesday': ['среда', 'ср', 'Среду'],
    'thursday': ['четверг', 'чт'],
    'friday': ['пятница', 'пт', 'Пятницу'],
    'saturday': ['суббота', 'сб', 'Субботу'],
    'sunday': ['воскресенье', 'вс', 'Воскресение'],
    'am': ['дп'],
    'pm': ['пп'],
    'year': ['год', 'г', 'года', 'лет'],
    'month': ['месяц', 'мес', 'месяца', 'месяцев'],
    'week': ['неделя', 'нед', 'недели', 'недель', 'неделю'],
    'day': ['день', 'дн', 'дня', 'дней', 'сутки', 'суток'],
    'hour': ['час', 'ч', 'часа', 'часов'],
    'minute': ['минута', 'мин', 'минуты', 'минут', 'минуту'],
    'second': ['секунда', 'сек', 'с', 'секунды', 'секунд', 'секунду'],
    'relative-type': {
