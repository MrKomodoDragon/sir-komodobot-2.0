info = {
    'name': 'fr',
    'date_order': 'DMY',
    'january': ['janvier', 'janv', 'jan'],
    'february': ['février', 'févr', 'fév'],
    'march': ['mars'],
    'april': ['avril', 'avr'],
    'may': ['mai'],
    'june': ['juin', 'jun'],
    'july': ['juillet', 'juil', 'jul'],
    'august': ['août', 'aoû'],
    ...
    'am': ['am'],
    'pm': ['pm'],
    'year': ['année', 'an', 'a', 'années', 'ans'],
    'month': ['mois', 'm'],
    'week': ['semaine', 'sem', 'semaines'],
    'day': ['jour', 'j', 'jours'],
    'hour': ['heure', 'h', 'heures'],
    'minute': ['minute', 'min', 'minutes'],
    'second': ['seconde', 's', 'secondes'],
    'relative-type': {
    ...
    'relative-type-regex': {
        'in \\1 year': ['dans (\\d+) an', 'dans (\\d+) ans', 'dans (\\d+) a'],
        '\\1 year ago': [
            'il y a (\\d+) an',
            'il y a (\\d+) ans',
            'il y a (\\d+) a',
        ],
        'in \\1 month': ['dans (\\d+) mois', 'dans (\\d+) m'],
        '\\1 month ago': ['il y a (\\d+) mois', 'il y a (\\d+) m'],
        'in \\1 week': [
            'dans (\\d+) semaine',
            'dans (\\d+) semaines',
            'dans (\\d+) sem',
    ...
    'locale_specific': {
        ...
        'fr-SY': {'name': 'fr-SY'},
        'fr-TD': {'name': 'fr-TD'},
        'fr-CM': {'name': 'fr-CM', 'am': ['matin', 'mat'], 'pm': ['soir']},
        'fr-DZ': {'name': 'fr-DZ'},
        'fr-MF': {'name': 'fr-MF'},
        'fr-RW': {'name': 'fr-RW'},
        'fr-MR': {'name': 'fr-MR'},
