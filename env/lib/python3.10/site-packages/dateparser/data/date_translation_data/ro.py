info = {
    ...
    'february': ['februarie', 'feb', 'Febr'],
    'march': ['martie', 'mar', 'Mart'],
    'april': ['aprilie', 'apr'],
    'may': ['mai'],
    'june': ['iunie', 'iun'],
    'july': ['iulie', 'iul'],
    'august': ['august', 'aug'],
    'september': ['septembrie', 'sept', 'Sep'],
    'october': ['octombrie', 'oct'],
    'november': ['noiembrie', 'nov', 'Noiem'],
    'december': ['decembrie', 'dec'],
    'monday': ['luni', 'lun'],
    'tuesday': ['marți', 'mar'],
    'wednesday': ['miercuri', 'mie', 'Mi'],
    'thursday': ['joi'],
    'friday': ['vineri', 'vin'],
    ...
    'week': ['săptămână', 'săpt', 'săptămâni'],
    'day': ['zi', 'zile'],
    'hour': ['oră', 'h', 'ore'],
    'minute': ['minut', 'min', 'm', 'minute'],
    'second': ['secundă', 'sec', 's', 'secunde'],
    'relative-type': {
    ...
    'relative-type-regex': {
        ...
        '\\1 year ago': ['acum (\\d+) an', 'acum (\\d+) de ani'],
        'in \\1 month': [
            'peste (\\d+) lună',
            'peste (\\d+) de luni',
            'peste (\\d+) luni',
