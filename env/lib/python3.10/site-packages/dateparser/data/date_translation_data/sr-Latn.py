info = {
    ...
    'relative-type-regex': {
        ...
        '\\1 day ago': ['pre (\\d+) dana', 'pre (\\d+) d'],
        'in \\1 hour': ['za (\\d+) sat', 'za (\\d+) sati', 'za (\\d+) č'],
        '\\1 hour ago': ['pre (\\d+) sata', 'pre (\\d+) sati', 'pre (\\d+) č'],
        'in \\1 minute': [
            'za (\\d+) minut',
            'za (\\d+) minuta',
            'za (\\d+) min',
        ],
        '\\1 minute ago': ['pre (\\d+) minuta', 'pre (\\d+) min'],
        'in \\1 second': [
            'za (\\d+) sekundu',
            'za (\\d+) sekundi',
            'za (\\d+) sek',
