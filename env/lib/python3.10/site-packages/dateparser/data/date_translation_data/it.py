info = {
    ...
    'year': ['anno', 'anni'],
    'month': ['mese', 'mesi'],
    'week': ['settimana', 'sett', 'settimane'],
    'day': ['giorno', 'g', 'giorni'],
    'hour': ['ora', 'h', 'ore'],
    'minute': ['minuto', 'min', 'm', 'minuti'],
    'second': ['secondo', 'sec', 's', 'secondi'],
    'relative-type': {
    ...
    'relative-type-regex': {
        'in \\1 year': ['tra (\\d+) anno', 'tra (\\d+) anni'],
        '\\1 year ago': ['(\\d+) anno fa', '(\\d+) anni fa'],
        'in \\1 month': ['tra (\\d+) mese', 'tra (\\d+) mesi'],
        '\\1 month ago': ['(\\d+) mese fa', '(\\d+) mesi fa'],
        'in \\1 week': [
            'tra (\\d+) settimana',
            'tra (\\d+) settimane',
            'tra (\\d+) sett',
        ...
        'in \\1 hour': ['tra (\\d+) ora', 'tra (\\d+) ore', 'tra (\\d+) h'],
        '\\1 hour ago': ['(\\d+) ora fa', '(\\d+) ore fa', '(\\d+) h fa'],
        'in \\1 minute': [
            'tra (\\d+) minuto',
            'tra (\\d+) minuti',
            'tra (\\d+) min',
