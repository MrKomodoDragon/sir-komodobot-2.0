info = {
    ...
    'day': ['dag', 'dagen'],
    'hour': ['uur'],
    'minute': ['minuut', 'min', 'minuten'],
    'second': ['seconde', 'sec', 's', 'seconden'],
    'relative-type': {
    ...
    'relative-type-regex': {
        'in \\1 year': ['over (\\d+) jaar'],
        '\\1 year ago': ['(\\d+) jaar geleden'],
        'in \\1 month': ['over (\\d+) maand', 'over (\\d+) maanden'],
        '\\1 month ago': ['(\\d+) maand geleden', '(\\d+) maanden geleden'],
        'in \\1 week': ['over (\\d+) week', 'over (\\d+) weken'],
        '\\1 week ago': ['(\\d+) week geleden', '(\\d+) weken geleden'],
        'in \\1 day': [
            'over (\\d+) dag',
            'over (\\d+) dagen',
            'over (\\d+) dgn',
        ...
        'in \\1 hour': ['over (\\d+) uur'],
        '\\1 hour ago': ['(\\d+) uur geleden'],
        'in \\1 minute': [
            'over (\\d+) minuut',
            'over (\\d+) minuten',
            'over (\\d+) min',
