info = {
    ...
    'july': ['ஜூலை'],
    'august': ['ஆகஸ்ட்', 'ஆக'],
    'september': ['செப்டம்பர்', 'செப்'],
    'october': ['அக்டோபர்', 'அக்'],
    'november': ['நவம்பர்', 'நவ'],
    'december': ['டிசம்பர்', 'டிச'],
    'monday': ['திங்கள்', 'திங்'],
    'tuesday': ['செவ்வாய்', 'செவ்'],
    'wednesday': ['புதன்', 'புத'],
    'thursday': ['வியாழன்', 'வியா'],
    'friday': ['வெள்ளி', 'வெள்'],
    'saturday': ['சனி'],
    'sunday': ['ஞாயிறு', 'ஞாயி'],
    'am': ['முற்பகல்'],
    ...
    'relative-type-regex': {
        'in \\1 year': ['(\\d+) ஆண்டில்', '(\\d+) ஆண்டுகளில்', '(\\d+) ஆ'],
        '\\1 year ago': [
            '(\\d+) ஆண்டிற்கு முன்',
            '(\\d+) ஆண்டுகளுக்கு முன்',
            '(\\d+) ஆ முன்',
        ...
        'in \\1 day': ['(\\d+) நாளில்', '(\\d+) நாட்களில்', '(\\d+) நா'],
        '\\1 day ago': [
            '(\\d+) நாளுக்கு முன்',
            '(\\d+) நாட்களுக்கு முன்',
            '(\\d+) நா முன்',
        ],
        'in \\1 hour': ['(\\d+) மணிநேரத்தில்', '(\\d+) மணி', '(\\d+) ம'],
        '\\1 hour ago': [
            '(\\d+) மணிநேரம் முன்',
            '(\\d+) மணி முன்',
            '(\\d+) ம முன்',
