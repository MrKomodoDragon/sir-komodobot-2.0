info = {
    ...
    'relative-type-regex': {
        'in \\1 year': ['oor (\\d+) jaar'],
        '\\1 year ago': ['(\\d+) jaar gelede'],
        'in \\1 month': ['oor (\\d+) minuut', 'oor (\\d+) md'],
        '\\1 month ago': [
            '(\\d+) maand gelede',
            '(\\d+) maande gelede',
            '(\\d+) md gelede',
        ],
        'in \\1 week': ['oor (\\d+) week', 'oor (\\d+) weke', 'oor (\\d+) w'],
        '\\1 week ago': [
            '(\\d+) week gelede',
            '(\\d+) weke gelede',
            '(\\d+) w gelede',
        ...
        '\\1 day ago': ['(\\d+) dag gelede', '(\\d+) dae gelede'],
        'in \\1 hour': ['oor (\\d+) uur'],
        '\\1 hour ago': ['(\\d+) uur gelede'],
        'in \\1 minute': ['oor (\\d+) minuut', 'oor (\\d+) min'],
        '\\1 minute ago': [
            '(\\d+) minuut gelede',
            '(\\d+) minute gelede',
            '(\\d+) min gelede',
