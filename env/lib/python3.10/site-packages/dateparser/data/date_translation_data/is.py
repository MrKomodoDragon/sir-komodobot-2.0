info = {
    ...
    'relative-type': {
        ...
        '1 month ago': ['í síðasta mánuði', 'í síðasta mán'],
        '0 month ago': ['í þessum mánuði', 'í þessum mán'],
        'in 1 month': ['í næsta mánuði', 'í næsta mán'],
    ...
    'relative-type-regex': {
        'in \\1 year': ['eftir (\\d+) ár'],
        '\\1 year ago': ['fyrir (\\d+) ári', 'fyrir (\\d+) árum'],
        'in \\1 month': [
            'eftir (\\d+) mánuð',
            'eftir (\\d+) mánuði',
            'eftir (\\d+) mán',
        ...
        'in \\1 week': ['eftir (\\d+) viku', 'eftir (\\d+) vikur'],
        '\\1 week ago': ['fyrir (\\d+) viku', 'fyrir (\\d+) vikum'],
        'in \\1 day': ['eftir (\\d+) dag', 'eftir (\\d+) daga'],
        '\\1 day ago': ['fyrir (\\d+) degi', 'fyrir (\\d+) dögum'],
        'in \\1 hour': [
            'eftir (\\d+) klukkustund',
