info = {
    ...
    'relative-type-regex': {
        ...
        'in \\1 day': ['за (\\d+) дан', 'за (\\d+) дана', 'за (\\d+) д'],
        '\\1 day ago': ['пре (\\d+) дана', 'пре (\\d+) д'],
        'in \\1 hour': ['за (\\d+) сат', 'за (\\d+) сати', 'за (\\d+) ч'],
        '\\1 hour ago': ['пре (\\d+) сата', 'пре (\\d+) сати', 'пре (\\d+) ч'],
        'in \\1 minute': [
            'за (\\d+) минут',
            'за (\\d+) минута',
            'за (\\d+) мин',
        ],
        '\\1 minute ago': ['пре (\\d+) минута', 'пре (\\d+) мин'],
        'in \\1 second': [
            'за (\\d+) секунду',
            'за (\\d+) секунди',
            'за (\\d+) сек',
