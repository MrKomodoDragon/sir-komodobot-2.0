info = {
    ...
    'relative-type-regex': {
        'in \\1 year': ['(\\d+) aasta pärast', '(\\d+) a pärast'],
        '\\1 year ago': ['(\\d+) aasta eest', '(\\d+) a eest'],
        'in \\1 month': ['(\\d+) kuu pärast', '(\\d+) k pärast'],
        '\\1 month ago': ['(\\d+) kuu eest', '(\\d+) k eest'],
        'in \\1 week': ['(\\d+) nädala pärast', '(\\d+) näd pärast'],
        '\\1 week ago': ['(\\d+) nädala eest', '(\\d+) näd eest'],
        'in \\1 day': ['(\\d+) päeva pärast', '(\\d+) p pärast'],
        '\\1 day ago': ['(\\d+) päeva eest', '(\\d+) p eest'],
        'in \\1 hour': ['(\\d+) tunni pärast', '(\\d+) t pärast'],
        '\\1 hour ago': ['(\\d+) tunni eest', '(\\d+) t eest'],
        'in \\1 minute': ['(\\d+) minuti pärast', '(\\d+) min pärast'],
        '\\1 minute ago': ['(\\d+) minuti eest', '(\\d+) min eest'],
        'in \\1 second': [
            '(\\d+) sekundi pärast',
            '(\\d+) sek pärast',
            '(\\d+) s pärast',
