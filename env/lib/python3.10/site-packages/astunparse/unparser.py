...
class Unparser:
    ...
    def _If(self, t):
        ...
        while (
            t.orelse and len(t.orelse) == 1 and isinstance(t.orelse[0], ast.If)
        ):
            t = t.orelse[0]
            self.fill('elif ')
            self.dispatch(t.test)
    ...
    def _Constant(self, t):
        ...
        if isinstance(value, tuple):
            ...
            if len(value) == 1:
                ...
                interleave(
                    lambda: self.write(', '), self._write_constant, value
                )
            self.write(')')
    ...
    def _UnaryOp(self, t):
        ...
        if (
            ...
            and isinstance(t.operand, ast.Num)
        ):
...
def roundtrip(filename, output=sys.stdout):
    if six.PY3:
        ...
        with open(filename, 'r') as pyfile:
            source = pyfile.read()
    tree = compile(
        source, filename, 'exec', ast.PyCF_ONLY_AST, dont_inherit=True
    )
