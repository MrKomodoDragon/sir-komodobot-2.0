    ...
    if not years and days < 1:
        ...
        if not months and not days:
            ...
            if months == 1:
                ...
                return (
                    ngettext('1 year, %d month', '1 year, %d months', months)
                    % months
                )
        else:
            return ngettext('1 year, %d day', '1 year, %d days', days) % days
...
def precisedelta(
    value, minimum_unit='seconds', suppress=(), format='%0.2f'
) -> str:
    ...
    months, days = _quotient_and_remainder(
        days, 30.5, MONTHS, min_unit, suppress
    )
    ...
    hours, secs = _quotient_and_remainder(
        secs, 3600, HOURS, min_unit, suppress
    )
    minutes, secs = _quotient_and_remainder(
        secs, 60, MINUTES, min_unit, suppress
    )
