...
class IteratorStream(ContentStream):
    ...
    def __init__(
        ...
        close_func: typing.Callable = None,
    ) -> None:
    ...
    def __aiter__(self) -> typing.AsyncIterator[bytes]:
        raise RuntimeError(
            'Attempted to call a async iterator on an sync stream.'
        )
...
class AsyncIteratorStream(ContentStream):
    ...
    def __init__(
        self,
        aiterator: typing.AsyncIterator[bytes],
        close_func: typing.Callable = None,
    ) -> None:
    ...
    class DataField:
        ...
        def __init__(self, name: str, value: typing.Union[str, bytes]) -> None:
            ...
            if not isinstance(value, (str, bytes)):
                raise TypeError(
                    'Invalid type for value. Expected str or bytes.'
                )
            self.name = name
            self.value = value
