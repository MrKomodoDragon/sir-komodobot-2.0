...
class URL:
    ...
    def copy_with(self, **kwargs: typing.Any) -> 'URL':
        if (
            ...
            port = kwargs.pop(
                'port', None if self.is_relative_url else self.port
            )
    ...
    def join(self, relative_url: URLTypes) -> 'URL':
        ...
        return URL(
            relative_url._uri_reference.resolve_with(base_uri).unsplit()
        )
...
class Origin:
    ...
    def __repr__(self) -> str:
        class_name = self.__class__.__name__
        return f'{class_name}(scheme={self.scheme!r} host={self.host!r} port={self.port})'
...
class Headers(typing.MutableMapping[str, str]):
    ...
    def __init__(
        self, headers: HeaderTypes = None, encoding: str = None
    ) -> None:
        if headers is None:
            ...
            self._list = [
                (
                    normalize_header_key(k, encoding),
...
class Response:
    ...
    def is_redirect(self) -> bool:
        return (
            StatusCode.is_redirect(self.status_code)
    ...
    def links(
        self,
    ) -> typing.Dict[typing.Optional[str], typing.Dict[str, str]]:
        """
