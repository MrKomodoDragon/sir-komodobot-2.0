...
class H2Connection(object):
    ...
    def close_connection(
        self, error_code=0, additional_data=None, last_stream_id=None
    ):
    ...
    def advertise_alternative_service(
        self, field_value, origin=None, stream_id=None
    ):
        """
    ...
    def prioritize(
        self, stream_id, weight=None, depends_on=None, exclusive=None
    ):
        """
