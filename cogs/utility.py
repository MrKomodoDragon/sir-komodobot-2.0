...
class Utility(commands.Cog):
    ...
    async def buttons(self, ctx):
        thing = discord.http.Route(
            'POST', f'/channels/{ctx.channel.id}/messages'
        )
        json = {
            'content': 'a',
            'components': [
                    ...
                    'components': [
                        {
                            ...
                            'options': [
                                ...
                                {
                                    'label': 'r',
                                    'value': 'fgdgfgdddddddddddddddddd',
                                },
                                {
                                    'label': 's',
                                    'value': 'fgdgdgfjlkkkkkkkkkdg',
                                },
                                {
                                    'label': 't',
                                ...
                                {
                                    'label': 'u',
                                    'value': 'fgdlfdgkjjjjjjjjjjgdg',
                                },
                                {'label': 'v', 'value': 'dgdgdffdglk;;;;;g'},
                                {
                                    'label': 'w',
                                    'value': 'dfgddfgkldgkdlkg;fdgg',
                                },
                            ],
                        }
                    ],
